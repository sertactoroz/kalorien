...
class _AnimatedNotchBottomBarState extends State<AnimatedNotchBottomBar> {
  ...
  double _lastItemPosition() {
    return _screenWidth - (_screenWidth - kMargin * 2) * 0.1 - (kCircleRadius + kCircleMargin) * 2;
  }

  double _itemDistance() {
    return (_lastItemPosition() - _firstItemPosition()) / (widget.bottomBarItems.length - 1);
  }
